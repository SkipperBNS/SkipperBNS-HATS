...
if (Test-Path $Pack) {
Write-Host "Cleaning pack directory..."
...
# We copy the CONTENTS of SdOut into the final pack.
...
# Look for SdOut anywhere inside the extracted archive.
$SdOut = Get-ChildItem `
...
# Some HATS releases may already contain SD contents
...
if ($Component.mode -eq "hats_base") {
    ...
    $DownloadPath = Join-Path $Work "HATS-$SafeAssetName"
...
switch ($Component.mode) {
    ...
    "zip" {
        ...
        # Merge ZIP contents into final SD root.
        Merge-DirectoryContents `
            -Source $ExtractPath `
            -Destination $Pack
...
# VERIFY CUSTOM HEKATE BACKGROUND
...
throw "Custom Hekate background is missing: bootloader/res/background.bmp"
}

$BackgroundFile = Get-Item $BackgroundPath

if ($BackgroundFile.Length -le 0) {
throw "Custom Hekate background is empty: bootloader/res/background.bmp"
}
...
# VERIFY BACKGROUND DIRECTORY

# ------------------------------------------------------------

Write-Host ""
Write-Host "========================================"
Write-Host "Checking Hekate resource directory"
Write-Host "========================================"

$HekateRes = Join-Path $Pack "bootloader\res"

if (Test-Path $HekateRes) {
Write-Host "OK: bootloader/res"
}
else {
throw "Hekate resource directory is missing: bootloader/res"
}
...
Compress-Archive `    -Path (Join-Path $Pack "*")`
...
Write-Host ""
Write-Host "========================================"
Write-Host "FINAL BUILD VERIFICATION"
Write-Host "========================================"
...
Write-Host "Required files confirmed:"
Write-Host "  [OK] bootloader/res/background.bmp"
Write-Host "  [OK] switch/ftpd.nro"
Write-Host "  [OK] switch/checkpoint.nro"
...
Write-Host "========================================"
Write-Host ""
Write-Host "SkipperBNS HATS pack created successfully."
